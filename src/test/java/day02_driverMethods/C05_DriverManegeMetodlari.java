...
public class C05_DriverManegeMetodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
        implicty wait  driverin aradigi elemetleri bulabilmesi icin
        kendsisne verdigimiz arastirma suresidir o sure icerisinde
